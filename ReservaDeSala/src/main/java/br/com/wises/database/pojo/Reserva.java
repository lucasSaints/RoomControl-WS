...
@XmlRootElement
@NamedQueries({
    //@NamedQuery(name = "Reserva.cancelaReserva", query = "UPDATE a SET ativo=0 WHERE a.id = :id SELECT a FROM Reserva a"),
...
public class Reserva implements Serializable {
    ...
    public String toString() {
        return "br.com.wises.database.pojo.Reserva[ id=" + this.id + "; ativo=" + this.ativo + " ]";
    }
